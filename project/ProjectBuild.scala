...
//  private val AKKA_STREAMS_VERSION = "2.0-M1"
  ...
  val akkaHttp =          "com.typesafe.akka"             %% "akka-http-experimental"                    % AKKA_VERSION
  val akkaHttpTestKit =   "com.typesafe.akka"             %% "akka-http-testkit"                         % AKKA_VERSION   % "test"
...
object BuildSettings {
  ...
  lazy val commonSettings = Seq(
    ...
    version             := APP_VERSION,
    scalacOptions       += s"-target:jvm-$JAVA_VERSION",
